...
const CACHE = 'medbank-v191';   // v191: Mastery grid — "Show all (N)" expander (8 weakest by default) + a "drill: Whole topic / This difficulty" toggle (tap defaults to whole topic)
