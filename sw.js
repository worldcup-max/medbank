...
const CACHE = 'medbank-v215';   // v215: 3D player fixes (trace narration crash, tapped-part visibility, bone highlight blow-out). The fetch handler is CACHE-FIRST, so viz3d.js changes are invisible to a device that already cached it until this string changes. Bump it whenever a shipped asset changes behaviour.
