...
const CACHE = 'medbank-v200';   // v200: Desktop home = D2 dashboard (full-width hero + 4 stat cards + continue + progress, responsive; phone keeps its banner layout); removed the stat tiles + the More toggle (everything inline); recolored the floating study-timer pill purple->teal so it no longer blends into the hero
