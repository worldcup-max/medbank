...
const CACHE = 'medbank-v223';   // v223: dark mode (Light/Dark/Auto switch in the sidebar) + the account
...
const ASSETS = ['./', './index.html', './app.html', './content.js', './icon.svg', './manifest.webmanifest',
  ...
  './lecture-record.js', './study-timer.js', './study-dock.js?v=20260908', './content-loader.js', './auth-ui.js?v=20260908',
