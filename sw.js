...
const CACHE = 'medbank-v216';   // v216: the voice now sets the pace of Play and TRACE (app.html + viz3d.js both changed), and the vertebral column is complete. The fetch handler is CACHE-FIRST, so viz3d.js and app.html changes are invisible to a device that already cached them until this string changes. Bump it whenever a shipped asset changes behaviour.
